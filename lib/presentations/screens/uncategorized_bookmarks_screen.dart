...
class UncategorizedBookmarksScreen extends StatelessWidget {
  UncategorizedBookmarksScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      body: Obx(() => _controller.loader.value
          ...
          : ListView.builder(
              itemCount: _controller.uncategorizedBookmarksList.length,
              itemBuilder: (context, index) {
                final bookmark = _controller.uncategorizedBookmarksList[index];
                return ListTile(
